...
function getMsg(){
	var slogan = [
	  "每个时光瞬间往往都会波澜汹涌<br>人潮中总有一个迷失的自己",
    "在无数个彷徨的夜晚<br>我陷入都市水泥丛林的阴影",
    "若这世间浑浊<br>清醒便是罪",
...
var tags = [
  ...
  '果粉', '对Apple理念持负面评价的Apple用户', '微软大法好',
